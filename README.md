...
1. Clone the repo
   ```sh
   git clone https://github.com/peterpaker48/Easy-Consulting-react
   ```
...
Project Link: [https://github.com/peterpaker48/Easy-Consulting-react](https://github.com/peterpaker48/Easy-Consulting-react)
